...
/*
What's the runtime for getting the edge weight between two vertices?
O(logn)
What's the runtime for getting all incoming edges to a vertex?
O(n)
What's the runtime for getting all outgoing edges from a vertex?
O(n)
*/